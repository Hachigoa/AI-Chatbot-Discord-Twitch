...
async function queryGemini(prompt) {
  ...
  const res = await fetch(
    "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent",
    {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${credentials.private_key}`, // For service account OAuth, replace with proper token
  ...
  return json.candidates[0].output || "I have no response right now.";
}
